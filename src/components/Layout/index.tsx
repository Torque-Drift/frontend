    ...
    <div className="min-h-screen bg-black text-cyan-400 overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <header className="flex justify-between items-center mb-16">
          <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-600 glitch-text cursor-pointer" onClick={() => router.push("/")}>
          ...
          <nav>
            <ul className="flex space-x-6 items-center">
              <li>
                <a
                  href="/"
                  className={`${pathname === "/" ? "text-cyan-300" : "hover:text-cyan-300"} transition-colors`}
                >
                  Home
                </a>
              </li>
              <li>
                <a
                  href="/token-sale"
                  className={`${pathname === "/token-sale" ? "text-cyan-300" : "hover:text-cyan-300"} transition-colors`}
                >
                  Token Sale
                </a>
              </li>
              <li>
                <a
                  href="/mystery-box"
                  className={`${pathname === "/mystery-box" ? "text-cyan-300" : "hover:text-cyan-300"} transition-colors`}
                >
                  Mystery Box
                </a>
              </li>
              <li>
                <a
                  href="/inventory"
                  className={`${pathname === "/inventory" ? "text-cyan-300" : "hover:text-cyan-300"} transition-colors`}
                >
                  Inventory
                </a>
              </li>
