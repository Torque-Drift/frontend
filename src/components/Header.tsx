  ...
  return (
    <header className="w-full fixed top-4 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-[#1A191B]/80 backdrop-blur-sm rounded-[20px] flex justify-between items-center h-16">
          {/* Logo */}
          ...
          <div className="lg:hidden">
            <button
              ...
              className="text-[#B5B2BC] hover:text-[#FFFFFF] p-2"
            >
                ...
                return (
                  ...
                  >
                    {(() => {
                      if (!connected) {
                        return (
                          <Button onClick={openConnectModal} type="button" className="text-sm px-3 py-2">
                            Connect
                          </Button>
                        );
                      }
                      ...
                      return (
                        <div className="flex items-center gap-2 sm:gap-3">
                          ...
                          <Button onClick={openChainModal} type="button" className="p-2">
                            {chain.hasIcon && (
                              <div
                                style={{
                          ...
                          <Button onClick={openAccountModal} type="button" className="text-sm px-3 py-2">
