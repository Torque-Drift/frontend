export function Street() {
  return (
    <div className="w-full h-[60px] sm:h-[80px] lg:h-[88px] bg-[#1A191B] border-y-2 sm:border-y-4 border-[#49474E] relative flex items-center justify-center overflow-hidden">
      <div className="bg-gradient-to-r from-black to-transparent h-full w-[30%] sm:w-[40%] absolute left-0 top-0 z-10" />
      <div className="bg-gradient-to-l from-black to-transparent h-full w-[30%] sm:w-[40%] absolute right-0 top-0 z-10" />
