...
export interface CryptoCoinAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addOperator"
      | "allowance"
...
export interface CryptoCoinAbi extends BaseContract {
  connect(runner?: ContractRunner | null): CryptoCoinAbi;
  waitForDeployment(): Promise<this>;

  interface: CryptoCoinAbiInterface;
