...
export interface GpuAbiInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addOperator"
      | "approve"
  ...
  encodeFunctionData(
    functionFragment: "setGPUCount",
    values: [BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "setGPUStatus",
...
export namespace boxOpenedEvent {
  ...
  export type OutputTuple = [tokenId: bigint, uri: string, power: bigint];
  export interface OutputObject {
    tokenId: bigint;
    uri: string;
    power: bigint;
...
export interface GpuAbi extends BaseContract {
  connect(runner?: ContractRunner | null): GpuAbi;
  waitForDeployment(): Promise<this>;

  interface: GpuAbiInterface;
  ...
  getGPUCount: TypedContractMethod<[tokenId: BigNumberish], [bigint], "view">;

  getHashPower: TypedContractMethod<[tokenId: BigNumberish], [bigint], "view">;
  ...
  setGPUCount: TypedContractMethod<
    [tokenId: BigNumberish, timestamp: BigNumberish],
    [void],
    "nonpayable"
  >;

  setGPUStatus: TypedContractMethod<
    [tokenId: BigNumberish, uri: string, power: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  userInventory: TypedContractMethod<
    [owner: AddressLike],
    [[bigint[], string[]]],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "userInventory"
  ): TypedContractMethod<[owner: AddressLike], [[bigint[], string[]]], "view">;
  ...
  filters: {
    ...
    "boxOpened(uint256,string,uint256)": TypedContractEvent<
      boxOpenedEvent.InputTuple,
      boxOpenedEvent.OutputTuple,
      boxOpenedEvent.OutputObject
    >;
